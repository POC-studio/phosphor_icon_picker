...
export function setupSettings(engine: CreativeEngine): void {
  ...
  // `playback/showAllBlocks` n’existe qu’à partir d’une version CE.SDK plus récente
  // que celle bundlée ici (1.74.1) — ignoré volontairement.
  // #endregion
