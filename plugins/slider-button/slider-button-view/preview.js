export default function (instance, properties) {
  ...
  knob.style.cssText =
    'position:absolute;left:0;top:50%;transform:translateY(-50%);width:36px;height:36px;border-radius:9999px;display:flex;align-items:center;justify-content:center;background:' +
    defaultColor +
